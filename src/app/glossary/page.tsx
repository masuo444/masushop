...
const glossaryTerms: GlossaryTerm[] = [
  ...
  // ===== 素材 =====
  {
    ...
    category: 'materials',
    definition:
      '枡の主要な素材となる日本の針葉樹。耐久性・耐水性に優れ、美しい木目と清々しい芳香が特徴。古くから神社仏閣の建築材としても用いられてきた高級木材。枡の産地として有名な岐阜県大垣市は、日本有数のヒノキの産地に近く、良質な国産ヒノキを使った枡作りが盛ん。建築材として使われた後のヒノキの端材を有効活用して枡が作られる。',

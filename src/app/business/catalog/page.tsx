...
// ── Order flow ──
const orderSteps = [
  { step: 1, title: 'ご相談', desc: 'サイズ・数量・加工方法・ご希望納期をお伝えください。ロゴデータや文章だけで構いません。' },
  { step: 2, title: 'お見積り＋仕上がりイメージ（無料）', desc: 'お見積りと一緒に仕上がりイメージ（レイアウト画像）をお送りします。' },
  { step: 3, title: 'ご注文確定', desc: 'イメージと金額を見てからご注文を判断。請求書払いもご相談いただけます。' },
  { step: 4, title: '製作', desc: '国産ヒノキで一つずつ丁寧に製作。進捗はメールでご報告。' },

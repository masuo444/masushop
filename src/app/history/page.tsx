...
export const metadata: Metadata = {
  title: '枡の歴史｜1300年の変遷と京枡・太閤検地をわかりやすく解説',
  description:
    '枡（ます）は701年の大宝律令に度量衡の規定が残る、奈良時代から続く日本の木製計量器。豊臣秀吉の太閤検地で京枡に統一され、明治の度量衡法で1升＝約1.8Lに。江戸の枡座、計量法による酒器への転身まで年代順に解説します。',
  keywords: [
    '枡 歴史',
    '升 歴史',
    '京枡',
...
const articleJsonLd = {
  ...
  '@type': 'Article',
  headline: '枡の歴史｜1300年の変遷と京枡・太閤検地をわかりやすく解説',
  description:
    ...
    <>
      ...
      <section className="max-w-4xl mx-auto px-6 pt-16 pb-12 text-center">
        ...
        <p data-speakable className="mt-6 text-sm leading-[2] max-w-2xl mx-auto text-[var(--foreground)]">
          枡（ます）は米や酒を量るための木製の計量器で、日本では701年の大宝律令に度量衡の規定が残る奈良時代から使われてきました。
          豊臣秀吉の太閤検地で「京枡」が全国標準となり、1891年の度量衡法で1升＝約1.8リットルと定められて、いまの<Link href="/products/ichigo" className="underline">一合（180ml）</Link>・<Link href="/products/issho" className="underline">一升（1,800ml）</Link>の基準になっています。
          1959年の計量法施行で計量器としての役割を終えたあとは、酒器・縁起物・名入れギフトの器として使われています。
        </p>
        <p className="mt-4 text-sm text-[var(--color-muted)] leading-[2] max-w-2xl mx-auto">
          穀物を量る素朴な木の器から、天下統一の道具へ、そして縁起物・酒器として愛される現代へ。枡が歩んだ1300年の歴史を年代順にたどります。
        </p>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 pb-16">
        <div className="bg-[var(--color-subtle)] border border-[var(--color-border)] p-8 rounded">
          <p className="text-[10px] tracking-[0.15em] uppercase text-[var(--color-muted)] mb-4">枡の歴史 早見年表</p>
          <dl className="grid grid-cols-[6.5rem_1fr] gap-x-4 gap-y-2 text-sm leading-[1.9]">
            <dt className="text-[var(--color-muted)]">701年</dt>
            <dd>大宝律令に度量衡の規定。米を量る基準器として枡が法的に位置づけられる</dd>
            <dt className="text-[var(--color-muted)]">1582年〜</dt>
            <dd>豊臣秀吉の太閤検地で京枡（方4寸9分・深さ2寸7分＝一升）に全国統一</dd>
            <dt className="text-[var(--color-muted)]">1669年</dt>
            <dd>江戸幕府が京枡を公式標準と定め、枡座を設置。公認の枡に焼印</dd>
            <dt className="text-[var(--color-muted)]">1891年</dt>
            <dd>度量衡法制定。メートル法との併用期間へ</dd>
            <dt className="text-[var(--color-muted)]">1959年</dt>
            <dd>計量法施行で商取引の尺貫法が禁止。枡は酒器・縁起物へ</dd>
          </dl>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-6 py-20 space-y-24">
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
            ...
            <p>
              当時の日本は豊かな森林資源に恵まれた「木の国」でした。建築、船、日用品のほとんどが木で作られていた時代に、計量器もまた木で作られるのは自然なことでした。特に<Link href="/glossary#hinoki" className="underline">ヒノキ</Link>は耐久性と防腐性に優れ、水にも比較的強いことから、液体も量る枡の素材として適していました。当店の枡が今も<Link href="/products" className="underline">国産ヒノキ</Link>で作られているのは、この理由の延長線上にあります。
            </p>
            <p>
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
            ...
            <p>
              秀吉が定めた<Link href="/glossary#kyomasu" className="underline">京枡</Link>の規格は「方4寸9分、深さ2寸7分」。現代の単位に換算すると、約148.5mm四方、深さ約81.8mmとなり、容量は一升（約1.8リットル）に相当します。この寸法は厳格に管理され、全国どこでも同じ枡を使って米の収穫量を計測することが義務づけられました。当店の<Link href="/products/issho" className="underline">一升枡</Link>（170×170×92mm）は、この一升をそのまま受け継いだ最大サイズです。
            </p>
            <p>
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
            ...
            <p>
              枡座が管理する公認の枡には<Link href="/glossary#yakiin" className="underline">焼印</Link>が押され、焼印のない枡の使用は禁止されました。これは現代でいう計量器の検定制度の原型であり、日本の度量衡行政の出発点ともいえます。枡座の存在により、枡の信頼性が制度的に担保されるようになったのです。約400度の銅版で押す焼印は、いまも<Link href="/products/engraving" className="underline">枡の名入れ方法</Link>のひとつとして受け継がれています。
            </p>
            <p>
            ...
            <p>
              また、江戸時代には枡にまつわる縁起担ぎも庶民の間に広まりました。「枡（ます）」は「益す」「増す」に通じることから、商売繁盛や五穀豊穣を願って枡を飾る風習が生まれました。<Link href="/glossary#setsubun" className="underline">節分の豆まき</Link>に枡を使う習慣も、この時代に定着したとされています。枡は計量器であると同時に、福を招く縁起物としての二つの顔を持つようになったのです。豆まきには今も<Link href="/products/gogo" className="underline">五合枡（900ml）</Link>が最も一般的に使われています。
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
            ...
            <p>
              昭和30年代（1955年〜）、テレビの普及とともに日本酒を枡で飲む映像が全国に広まりました。居酒屋や料亭で日本酒を枡に注いで提供するスタイルが「粋」な飲み方として人気を博し、枡は計量器から酒器・祝い酒の器へと華麗な転身を遂げたのです。居酒屋の「<Link href="/sake" className="underline">もっきり</Link>」に使われる<Link href="/products/hasshaku" className="underline">八勺枡</Link>や、日本酒一合がちょうど入る<Link href="/products/ichigo" className="underline">一合枡</Link>は、この酒器としての枡の代表です。
            </p>
            <p>
              岐阜県の枡職人たちは、この変化にいち早く対応しました。計量器としての需要が減る一方で、酒器・ギフト・縁起物としての需要を開拓し、枡の文化を次の世代へとつなげていったのです。
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
            <p>
              計量器としての実用を離れた現代の枡は、日本文化を象徴する多彩な顔を持っています。正月の祝い酒、節分の豆まき、結婚式の<Link href="/business/ceremony" className="underline">鏡開き</Link>、企業の<Link href="/business" className="underline">ノベルティ</Link>、海外へのお土産——枡が活躍する場面は実に幅広く、むしろ計量器時代よりも多様な使われ方をしています。枡の一般的なサイズは<Link href="/products/sizes" className="underline">三勺（54ml）から一升（1,800ml）までの7サイズ</Link>です。
            </p>
            <p>
              特に注目すべきは、枡に由来する単位が現代の日常に深く根付いていることです。「一合炊き」の炊飯器、「一升瓶」の日本酒、「一升餅」のお祝い——これらはすべて枡の容量単位に基づいています。法的にはメートル法に統一されたにもかかわらず、私たちの生活の中に枡の単位は息づいているのです。勺・合・升の関係は<Link href="/glossary#gou" className="underline">枡用語辞典</Link>で解説しています。
            </p>
            <p>
              縁起物としての枡の人気も衰えることがありません。「枡（ます）」は「益す」「増す」に通じることから、結婚式では「幸せが益す」、商売では「商い益々繁盛」の意味を込めて贈られます。名入れ技術の進化により、<Link href="/products/engraving" className="underline">レーザー刻印</Link>で自由なデザインが可能になったことも、ギフトとしての需要拡大を後押ししています。名前や日付を刻んだ<Link href="/original" className="underline">オリジナル枡</Link>は1個から作れるようになりました。
            </p>
            <p>
      ...
      <section className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
          ...
          <p>
            一般的に、木製の計量器・酒器としての「ます」を指す場合は「枡」の表記が最も広く使われています。当サイトでも「枡」を標準表記として採用しています。3つの漢字の違いは<Link href="/glossary#masu" className="underline">枡用語辞典</Link>でも解説しています。
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
          <p>
            現在、日本で生産される枡の約80%は岐阜県で製造されています。岐阜県は日本最大の枡の産地です。
          </p>
          <p>
            岐阜県が枡の一大産地となった背景には、地理的な条件が深く関わっています。日本有数のヒノキの産地である東濃地方（岐阜県南東部）を擁し、良質な国産ヒノキを安定的に調達できる立地にあります。また、木曽三川（木曽川・長良川・揖斐川）の水運により、木材の輸送にも恵まれていました。
          </p>
          <p>
            計量法の変遷により枡の需要構造が変化するなかで、枡職人たちは伝統の技術を守りながらも、酒器や贈答品など新たな用途の枡づくりに果敢に挑戦し続けました。
          </p>
          <p>
            現在の枡づくりでは、伝統的な手仕事と現代の機械技術を融合させた製造体制が確立されています。木材の乾燥から、モルダー加工、ほぞ切り、組み、仕上げ削り、面取りまでの各工程は、職人の目と手の感覚が品質を支えています。一方で、名入れ加工にはレーザー刻印などの最新技術も導入され、多様なニーズに対応しています。
          </p>
          <p>
            また、近年の枡づくりは環境への配慮でも注目を集めています。建築材として使われた後のヒノキ端材を原材料として活用し、梱包材にもヒノキの削り節を使うなど、脱プラスチックと森林資源の有効活用を同時に実現するサステナブルなものづくりが行われています。梱包に使われる削り節の活用法は<Link href="/care" className="underline">枡のお手入れ方法</Link>で紹介しています。
          </p>
        </div>
      </section>
      ...
      <RelatedMasu
        ids={['ichigo', 'issho', 'gogo', 'hasshaku']}
        heading="歴史を受け継ぐ、いまの枡"
        lead="京枡の一升、日本酒の一合、節分の五合、もっきりの八勺。いずれも国産ヒノキで、名入れは1個からご相談いただけます。"
      />

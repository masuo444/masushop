    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-20 space-y-24">
        ...
        <section>
          ...
          <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
            ...
            <p>
              縁起物としての枡の人気も衰えることがありません。「枡（ます）」は「益す」「増す」に通じることから、結婚式では「幸せが益す」、商売では「商い益々繁盛」の意味を込めて贈られます。名入れ技術の進化により、レーザー刻印やカラープリントで自由なデザインが可能になったことも、ギフトとしての需要拡大を後押ししています。
            </p>
            <p>
      ...
      <section className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-4 text-sm leading-[2.2] text-[var(--foreground)]">
          ...
          <p>
            現在の大垣の枡メーカーでは、伝統的な手仕事と現代の機械技術を融合させた製造体制が確立されています。木材の乾燥から、モルダー加工、ほぞ切り、組み、仕上げ削り、面取りまでの各工程は、職人の目と手の感覚が品質を支えています。一方で、名入れ加工にはレーザー刻印やシルクプリントなどの最新技術も導入され、多様なニーズに対応しています。
          </p>
          <p>

...
const giftReasons = [
  ...
  },
  {
    ...
    desc: '枡は約1300年の歴史を持つ日本の伝統工芸品。職人が一つひとつ丁寧に仕上げています。大量生産の工業製品にはない「手仕事の温もり」が、ギフトとしての特別感を演出します。海外の方への贈り物としても日本文化を伝える逸品です。',
  },
]
...
const giftFaqItems = [
  {
    q: '枡ギフトは何個から注文できますか？',
    a: '名入れのオリジナル枡は1個からご相談いただけます。結婚祝いのペア枡（2個セット）やご家族分のセットなど、少量でもお気軽にご相談ください。企業記念品など大口注文は10個から対応しており、まとめ買いほどお得な価格でご案内可能です。',
  },
  {
    q: '名入れの納期はどのくらいですか？',
  ...
  },
  {
    ...
    a: 'はい、ご要望に応じて熨斗やギフト包装に対応しております。一合枡のみ、木目や名入れを見せられるクリアケースと、贈答・記念品向けの白箱を各150円／個（税別）でご用意できます。「御結婚御祝」「御出産御祝」「御祝」「御礼」など、用途に合わせた表書きとあわせてご相談ください。',
  },
  {
